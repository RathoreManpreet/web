            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
              <div class="sm:col-span-1">
                  <p class="text-4sm font-medium text-gray-500">
                    H E S Concrete(High Early Stregth) is specially designed to enhance the early strength development in concrete. It allows form release and post tensioning. It can also be conveniently used in precast elements.
                  </p>
                  <p class="text-4sm mt-4 font-medium text-gray-500">
                    ...
                    <ul class="list-disc text-gray-500 list-inside">
                      <li>Early strength gain permits post tensioning</li>
                      <li>Early foam release possible during Precasting</li>
                      <li>Saves project time schedule</li>
                      <li>Can be used during cold weather</li>
                    </ul>
                  </p>
                  <p class="text-4sm mt-4 font-medium text-gray-500">
                    <h3 class="text-gray-500 font-bold">Design Characteristics</h3>
                    <ul class="list-disc text-gray-500 list-inside">
                      <li>High performance High strength concrete designed to match the project specifications</li>
                      <li>Early strength requirement specification shall be included at the design stage</li>
                    </ul>
                  </p>
                  <p class="text-4sm mt-4 font-medium text-gray-500">
                  <a  href="{{asset('assets/documents/Redx Specific HeS Concrete.pdf')}}" target="_new"><img src="{{asset('assets/image/Brochure-Download.png')}}" alt=""></a>
                  </p>
