        ...
        <main class="relative h-full mx-auto max-w-7xl px-4 flex items-center justify-center ">
            <div class="text-center">
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-7xl ">
                    <span class="block   text-white">Prod<span class=" text-red-600">uct</span> </span>
                </h1>
                        ...
                        <li class="flex">
                            <div class="flex items-center">
                                ...
                                <a href="#" aria-current="page"
                                    class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ $category->category_name }}</a>
                            </div>
                        </li>
                    @endif
                </ol>
                ...
                <div class="space-y-6 lg:col-start-1 lg:col-span-2">
                    ...
                    <section aria-labelledby="applicant-information-title">
                                ...
                                @foreach ($products as $product)
                                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                                        <div class="flex-shrink-0">
                                            <img class="h-48 w-full object-cover" src="{{ asset($product->thumbnail) }}"
                                                alt="">
                                        </div>
                                            ...
                                            <div class="flex-1">
                                                <a href="{{ route('product', [$product->category->slug, $product->slug]) }}"
                                                    ...
                                                    <p class="mt-3 text-base text-gray-700">
                                                        {{ strlen(strip_tags($product->product_desc)) > 100 ? substr(strip_tags($product->product_desc), 0, 100) . '...' : strip_tags($product->product_desc) }}
                                                    </p>
                                                </a>
                                            </div>
                        ...
                        @else
                            ...
                            <h1 class="text-center text-gray-400 mt-8 text-2xl">
